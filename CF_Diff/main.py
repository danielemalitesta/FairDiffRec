...
if __name__ == '__main__':
    ...
    best_recall, best_epoch, test_recall = -100, 0, 0.0
    ...
    folder_name = f"_valid_recall_{best_recall:.4f}_test_recall_{test_recall:.4f}"
    save_dir_path = os.path.join(args.save_path, folder_name)
