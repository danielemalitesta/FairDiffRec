...
def main():
    ...
    for hyperparam in hyperparams:
        ...
        if not completed:
            command_line = f'$HOME/.conda/envs/diffrec/bin/python main.py {to_cmd(hyperparam)} --cuda --dataset={args.dataset} --data_path={args.data_path}/{args.dataset}/ > {logs_path}/{args.dataset}/{logfile} 2>&1'
...
#SBATCH --output=../../../../../slogs/l-diffrec-%A_%a.out
#SBATCH --error=../../../../../slogs/l-diffrec-%A_%a.err
#SBATCH --partition={1}
#SBATCH --job-name=l-diffrec
#SBATCH --gres=gpu:1
...
cd $HOME/projects/FairDiffRec/L-DiffRec
        
        """
    else:
        header = """#!/bin/bash -l

#SBATCH --output=/workdir/%u/slogs/l-diffrec-%A_%a.out
#SBATCH --error=/workdir/%u/slogs/l-diffrec-%A_%a.err
#SBATCH --partition={1}
#SBATCH --job-name=l-diffrec
#SBATCH --gres=gpu:1
#SBATCH --mem=20GB # memory in Mb
...
cd $HOME/workspace/FairDiffRec/L-DiffRec
