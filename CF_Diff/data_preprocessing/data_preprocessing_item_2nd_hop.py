...
train_path = data_path + dataset_name + '/train_list.npy'
valid_path = data_path + dataset_name + '/valid_list.npy'
test_path = data_path + dataset_name + '/test_list.npy'
print(train_path)
print(valid_path)
print(test_path)
...
cf_diff_dir = os.path.dirname(script_dir)               
hops_dir = os.path.join(cf_diff_dir, 'hops')            
if not os.path.exists(hops_dir):
    os.makedirs(hops_dir)
filename = os.path.join(hops_dir, f"two_hop_rates_items_{dataset_name}.pt")
