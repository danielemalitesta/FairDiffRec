...
def main():
    ...
    for hyperparam in hyperparams:
        ...
        if not completed:
            command_line = f'$HOME/.conda/envs/diffrec/bin/python main_cluster.py {to_cmd(hyperparam)} --dataset={args.dataset} --data_path={args.data_path} > {logs_path}/{args.dataset}/{logfile} 2>&1'
