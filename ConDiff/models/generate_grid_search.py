...
def main():
    ...
    for hyperparam in hyperparams:
        ...
        if not completed:
            command_line = f'python /content/FairDiffRec/ConDiff/main.py {to_cmd(hyperparam)} --cuda --dataset={args.dataset} --data_path={args.data_path}/{args.dataset}/ > {logs_path}/{args.dataset}/{logfile} 2>&1'
